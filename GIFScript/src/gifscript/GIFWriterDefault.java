...
public class GIFWriterDefault implements GIFWriter {
	...
	public GIFWriterDefault ( int width, int height)
	{
		frames = new ArrayList<GIFFrame>();
		this.width = width; 
		this.height = height;
	...
	public GIFWriterDefault ( int width, int height, int loop)
	{
		frames = new ArrayList<GIFFrame>();
		this.width = width; 
		this.height = height;
	...
	public GIFWriterDefault ( int width, int height, GIFFrame scene)
	{
		frames = new ArrayList<GIFFrame>();
		this.width = width; 
		this.height = height;
	...
	public static void main ( String[] args) throws IOException
	{
        ...
        GIFWriterDefault writer = new GIFWriterDefault( 100, 100, -1);
